...
export const israelStocks: Stock[] = [
  ...
  { symbol: "TEVA.TA", company: "טבע", description: "חברת התרופות הגדולה בישראל ומהגדולות בעולם.", logoUrl: "/images/logos/teva.png", category: "רפואה 💊" },
  { symbol: "DSCT.TA", company: "בנק דיסקונט", description: "בנק מוביל בישראל עם שירותים לפרטיים ועסקיים.", logoUrl: "/images/logos/discount.png", category: "בנקאות 🏦" },
  { symbol: "MZTF.TA", company: "מזרחי טפחות", description: "בנק מוביל בתחום המשכנתאות והבנקאות הקמעונאית.", logoUrl: "/images/logos/mizrahi.png", category: "בנקאות 🏦" },
  { symbol: "ESLT.TA", company: "אלביט מערכות", description: "ענקית הטכנולוגיה הביטחונית הישראלית.", logoUrl: "/images/logos/elbit.png", category: "ביטחון 🛡️" },
  { symbol: "ICL.TA", company: "איי.סי.אל (ICL)", description: "חברה גלובלית לכימיקלים מיוחדים ודשנים.", logoUrl: "/images/logos/icl.png", category: "תעשייה ⚙️" },
  { symbol: "NVMI.TA", company: "נובה", description: "חברת מכשור למדידה ובקרה בתעשיית השבבים.", logoUrl: "/images/logos/nova.png", category: "טכנולוגיה 💻" },
  { symbol: "TSEM.TA", company: "טאואר", description: "יצרנית שבבים מובילה עם מפעלים בארץ ובעולם.", logoUrl: "/images/logos/tower.png", category: "שבבים 🧠" },
  { symbol: "AZRG.TA", company: "קבוצת עזריאלי", description: "קבוצת נדל\"ן מובילה בישראל – קניונים, משרדים ומגורים.", logoUrl: "/images/logos/azrieli.png", category: "נדל\"ן 🏗️" },
  { symbol: "BEZQ.TA", company: "בזק", description: "חברת התקשורת הגדולה בישראל.", logoUrl: "/images/logos/bezeq.png", category: "תקשורת 📡" },
  { symbol: "FIBI.TA", company: "הבינלאומי", description: "הבנק הבינלאומי הראשון לישראל.", logoUrl: "/images/logos/fibi.png", category: "בנקאות 🏦" },
  { symbol: "PHOE.TA", company: "הפניקס", description: "קבוצת ביטוח ופיננסים מהמובילות בישראל.", logoUrl: "/images/logos/phoenix.png", category: "ביטוח 🛡️" },
  { symbol: "HARL.TA", company: "הראל השקעות", description: "קבוצת ביטוח, פיננסים והשקעות מובילה.", logoUrl: "/images/logos/harel.png", category: "ביטוח 🛡️" },
  { symbol: "MLSR.TA", company: "מליסרון", description: "חברת נדל\"ן מניב מובילה – קניונים ומרכזי מסחר.", logoUrl: "/images/logos/melisron.png", category: "נדל\"ן 🏗️" },
  { symbol: "STRS.TA", company: "שטראוס גרופ", description: "קבוצת מזון ומשקאות מובילה בישראל.", logoUrl: "/images/logos/strauss.png", category: "מזון 🍽️" },
  { symbol: "SPEN.TA", company: "שפיר הנדסה", description: "חברת תשתיות, בנייה והנדסה מובילה.", logoUrl: "/images/logos/shapir.png", category: "תשתיות 🏗️" },
  { symbol: "ENRG.TA", company: "אנרג'יקס", description: "חברת אנרגיה מתחדשת – רוח, סולארי ואגירה.", logoUrl: "/images/logos/energix.png", category: "אנרגיה ⚡" },
  { symbol: "DLEKG.TA", company: "קבוצת דלק", description: "קבוצת אנרגיה ותשתיות עם פעילות בינלאומית.", logoUrl: "/images/logos/delek.png", category: "אנרגיה ⚡" },
  { symbol: "AMOT.TA", company: "אמות", description: "חברת נדל\"ן מניב – משרדים, מסחר ולוגיסטיקה.", logoUrl: "/images/logos/amot.png", category: "נדל\"ן 🏗️" },
  { symbol: "ARPT.TA", company: "איירפורט סיטי", description: "חברת נדל\"ן מניב סמוך לנתב\"ג.", logoUrl: "/images/logos/airport-city.png", category: "נדל\"ן 🏗️" },
  { symbol: "SAE.TA", company: "שופרסל", description: "רשת הסופרמרקטים הגדולה בישראל.", logoUrl: "/images/logos/shufersal.png", category: "קמעונאות 🛒" },
  { symbol: "BIG.TA", company: "ביג", description: "חברת נדל\"ן מסחרי – מרכזי קניות ופאוור סנטרס.", logoUrl: "/images/logos/big.png", category: "נדל\"ן 🏗️" },

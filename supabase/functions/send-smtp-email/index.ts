      ...
      <div style="width: 100%; background-color: #f5f5f5; padding: 20px 0;">
        <div style="max-width: 800px; margin: 0 auto; background-color: #FFF;">
          ...
          <div style="position: relative; width: 100%; height: 327px; background: #FFC547; overflow: hidden;">
            ...
            <!-- All decorative elements positioned exactly from new Figma coordinates -->
            ...
            <svg 
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <path d="M46.9524 52.6367L53.4652 32.1768L58.7908 51.1159L74.7845 45.7734L62.9122 60.5855L73.8856 73.9051L58.7908 70.0551L52.2949 88.412L46.3588 69.4615L33.344 75.3807L42.537 62.3607L28.9121 45.502L46.9524 52.6367Z" fill="#E96036"/>
